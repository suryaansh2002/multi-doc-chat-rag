  ...
  return (
    <div className="min-h-screen bg-gray-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        {!otpVerified && <p className="mt-2 text-center text-sm text-gray-300">Enter the code sent to your email</p>}
      </div>
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  value={email}
                  disabled
                  className="appearance-none block w-full px-3 py-2 border border-gray-600 rounded-md shadow-sm bg-gray-700 text-gray-300"
                />
              </div>
            </div>
